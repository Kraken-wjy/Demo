...
export default function CharacterCard({ name, description, image, rotation = 0, delay = 0, isModalOpen = false, onOpenModal, onCloseModal }: CharacterCardProps) {
  ...
  return (
    <div style={{ perspective: '1000px', position: 'relative', zIndex: 50 }}>
        <motion.div
          ref={cardRef}
